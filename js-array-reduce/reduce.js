...
function extractValue(arr, key) 
{
    ...
    //     return val[key]
    // })
    return arr.reduce(function(acum, nextVal)
    {
        acum.push(nextVal[key])
        return acum
    },[])
}
...
{
    const vowels = 'aeiou'
    return str.split('').reduce(function(acum, nextVal)
    {
...
{
    return arr.reduce(function(acum, nextVal, index)
    {
        acum[index][key] = value
        return acum
    },arr)
}
